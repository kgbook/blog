...
4. [设备发现总流程](#_4)
5. [从抓包时间线还原发现过程](#_5)
6. [抓包分析：Apple 设备怎么问](#_6)
7. [抓包分析：服务端应该怎么答](#_7)
8. [RAOP 响应包](#_8)
9. [AirPlay 响应包](#_9)
10. [TTL 和 cache flush](#_10)
11. [为什么响应要拆包](#_11)
12. [设计方案](#_12)
13. [实现流程](#_13)
14. [关键实现点](#_14)
15. [为什么不直接实现完整 DNS 压缩](#_15)
16. [Android 平台考虑](#_16)
17. [验证方式](#_17)
18. [代码下载](#_18)
19. [总结](#_19)
...
## 5. 从抓包时间线还原发现过程<span id="_5"></span>
...
## 6. 抓包分析：Apple 设备怎么问<span id="_6"></span>
...
## 7. 抓包分析：服务端应该怎么答<span id="_7"></span>
...
## 10. TTL 和 cache flush<span id="_10"></span>
...
## 15. 为什么不直接实现完整 DNS 压缩<span id="_15"></span>
...
## 16. Android 平台考虑<span id="_16"></span>
...
## 18. 代码下载<span id="_18"></span>

[UxPlay](https://github.com/kgbook/UxPlay)

## 19. 总结<span id="_19"></span>

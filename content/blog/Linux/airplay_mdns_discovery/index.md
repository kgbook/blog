...
- 新增 `lib/mdnsd.c`
- 新增 `lib/mdnsd.h`
- 重写 `lib/dnssd.c`，让它调用 `mdnsd`
- 移除 `libdns_sd` / Avahi / Bonjour SDK 相关构建依赖
- 清理 systemd service 和 spec 里的 Avahi 依赖
- 更新 README 里的构建和排障说明
- 删除过期生成文件 `README.html`

提交记录：

```text
3bdf24a60ab2ee1ff78ec72e2e02d047bb76db39 Replace DNS-SD dependency with built-in mDNS responder
```
